...
The missing bridge can now be stated sharply:

> Derive the two-channel overlap `lambda4=1-1/Q`, or its residual
> `S_Q=1-lambda4^2`, from the information metric of successive tetrahedral
> outcome distributions generated by the Q update.

If that succeeds, the chain would run from four-outcome information geometry,
through a settled three-dimensional record and its two-dimensional boundary
shear, to the gravitational normalization. At present this is the next target,
